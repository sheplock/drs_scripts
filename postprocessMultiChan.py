    ...
    for ievt in range(Nevt):
        ...
        if(chn1):
            ...
            if(imax>24 and imax<1000):
                ...
                noise_CH1[0] = 0.5*(np.percentile(vs[:istart*3/4],95) - np.percentile(vs[:istart*3/4],5))
                vs -= offset_CH1[0]
        ...
        if(chn2):
            ...
            if(imax>0 and imax<1024):
                ...
                noise_CH2[0] = 0.5*(np.percentile(vs[:istart*3/4],95) - np.percentile(vs[:istart*3/4],5))
                vs -= offset_CH2[0]
        ...
        if(chn3):
            ...
            if(imax>0 and imax<1024):
                ...
                noise_CH3[0] = 0.5*(np.percentile(vs[:istart*3/4],95) - np.percentile(vs[:istart*3/4],5))
                vs -= offset_CH3[0]
        ...
        if(chn4):
            ...
            if(imax>0 and imax<1024):
                ...
                offset_CH4[0] = np.mean(vs[30:istart*3/4])
                noise_CH4[0] = 0.5*(np.percentile(vs[:istart*3/4],95) - np.percentile(vs[:istart*3/4],5))
                vs -= offset_CH4[0]
